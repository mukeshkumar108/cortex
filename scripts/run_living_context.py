#!/usr/bin/env python3
"""Run Pass 5 living context synthesis using the shared live pass implementation."""
...
from src.derived_pipeline import run_pass5_living_context


async def run_once(*, user_id: str, tenant_id: str = "default") -> dict:
    db = Database()
    try:
        result = await run_pass5_living_context(db=db, tenant_id=tenant_id, user_id=user_id, settings=get_settings())
